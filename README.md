...
🚀 Currently improving my skills in **firmware development, C programming, Python, Git & documentation**.  
...
## 🌐 Connect With Me  
[![Instagram](https://img.shields.io/badge/Instagram-%23E4405F.svg?logo=Instagram&logoColor=white)](https://www.instagram.com/_vaishakx_d_k/)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/vaishak-d-karkera-49b6ba292/)
[![Email](https://img.shields.io/badge/Email-D14836?logo=gmail&logoColor=white)](mailto:vaishak3366@gmail.com)
...
![STM32](https://img.shields.io/badge/STM32-000?style=for-the-badge&logo=stmicroelectronics&logoColor=white)
...
📌 Smart system concept to improve public distribution efficiency using monitoring + automation  
**Tech:** `Embedded Systems` `IoT` `C`

### ✅ Smart Doorbell (Jarvis Team Project)  
📌 Real-time alerts + smart connectivity based security improvement  
**Tech:** `IoT` `ESP32` `Sensors`

### ✅ Home Automation (Multi-feature IoT Concept)  
📌 Gesture control, voice/app automation, Wi-Fi + Bluetooth control, smart security features  
**Tech:** `ESP32` `IoT` `Automation`
...
[![](https://visitcount.itsvg.in/api?id=VaishakSCEM543&icon=0&color=0)](https://visitcount.itsvg.in)
